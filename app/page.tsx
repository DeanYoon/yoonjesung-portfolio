...
export default function DigitalClock() {
  ...
  // 17x6 그리드 (총 102개) - 각 숫자가 4x6, 콜론 1열
  // 배치: [숫자1(4열)][숫자2(4열)][콜론(1열)][숫자3(4열)][숫자4(4열)]
  const displayPixels: number[] = new Array(102).fill(0);
  ...
  for (let row = 0; row < 6; row++) {
    for (let col = 0; col < 4; col++) {
      const index = row * 17 + (currentCol + col);
